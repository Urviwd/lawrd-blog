      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Know the Law,
            <span className="block text-blue-600">Drive Change</span>
          </h1>
          
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Stay current with the latest legal developments, court rulings, and regulatory changes. 
            Expert analysis and practical guidance for legal professionals and students.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">Legal Articles</p>
            </div>
            <div className="text-center">

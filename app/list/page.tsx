...
const blogData = {
  ...
  "Education & Learning": [
    ...
    },
    {
      ...
      excerpt: "Essential principles and practical applications of contract law",
      author: "Maria Garcia",
      rating: 4.8,
      reviews: 189,
      readTime: "30 min",
    ...
    {
      id: 9,
      title: "Criminal Procedure: A Complete Guide",
      excerpt: "Understanding criminal justice process from arrest to trial",
      author: "John Davis",
      rating: 4.7,
      reviews: 167,
      readTime: "28 min",
  ...
  "Case Studies": [
    {
      ...
      excerpt: "Analysis of a complex property case and its legal implications",
    ...
    {
      id: 11,
      title: "Corporate Merger: Legal Challenges",
      excerpt: "Case study of a major corporate merger and regulatory hurdles",
      author: "Kevin Lee",
      rating: 4.8,
      reviews: 178,
      readTime: "22 min",
    ...
    {
      id: 12,
      title: "Environmental Law: Pollution Case Study",
      excerpt: "Real-world example of environmental law enforcement",
      author: "Rachel Green",
      rating: 4.5,
      reviews: 134,
      readTime: "16 min",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        {Object.entries(filteredBlogData).map(([category, blogs]) => (
          <div
            key={category}
            className="mb-16"
          >

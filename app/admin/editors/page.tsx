...
export default function EditorsPage() {
  const [editors, setEditors] = useState<Editor[]>(mockEditors)
  ...
  const handleToggleStatus = (id: number) => {
    setEditors(prev => prev.map(editor => 
      editor.id === id 
        ? { ...editor, status: (editor.status === 'active' ? 'inactive' : 'active') as 'active' | 'inactive' }
        : editor
    ))
  }
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditingEditor(prev => prev ? { ...prev, name: e.target.value } : null)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditingEditor(prev => prev ? { ...prev, email: e.target.value } : null)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setEditingEditor(prev => prev ? { ...prev, role: e.target.value } : null)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
                  {roles.map(role => (
                    <option key={role} value={role}>{role}</option>
